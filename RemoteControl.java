...
Program: RemoteControl.java

Purpose: Implement remote control of the rover with object detection to prevent crashes due to human error.  
...
public class Ex2 {
    public static void main(String[] args) throws Exception{
        ...
        while(true){
            ...
            //Check if the distance from the sonar is less than 500 mm
